...
### Проект направлен на анализ ценовой конкуренции между продавцами на маркетплейсе Ozon, чтобы помочь производителям и продавцам:
#### 1.	Понимать свое положение на рынке относительно конкурентов
#### 2.	Оптимизировать ценообразование
#### 3.	Выявлять возможности для увеличения маржинальности
#### 4.	Принимать данные-driven решения по маркетинговым акциям
...
в котором в соответствующем формате представлены переработанные данные о собственном продукте ценах с учетом акций и минимальные цены конкурентов.
 
